...
public class ErrorBarTest
{
    ...
    throws Exception
  {
    ...
    double[] yData1 = { 100.0D, 100.0D, 100.0D, 50.0D, 50.0D, 50.0D, 50.0D };
    double[] errdata = { 50.0D, 20.0D, 10.0D, 50.0D, 40.0D, 20.0D, 10.0D };

    double[] yData2 = { 50.0D, 80.0D, 90.0D, 0.0D, 10.0D, 30.0D, 40.0D };
    double[] yData3 = { 150.0D, 120.0D, 110.0D, 100.0D, 90.0D, 70.0D, 60.0D };

    Chart mychart = new Chart(900, 700);
    mychart.getStyleManager().setYAxisMin(0.0D);
    mychart.getStyleManager().setYAxisMax(150.0D);
